const CACHE = "sina-v8";
const CORE = ["./", "index.html", "css/style.css", "js/app.js", "js/data/index.js", "js/data/papers.js", "js/data/anat3-orbit.js", "js/data/anat3-face-osteology.js", "js/data/anat3-facial-muscles.js", "manifest.webmanifest", "icons/favicon.svg", "icons/icon-192.png", "icons/icon-512.png", "icons/apple-touch-icon.png"];
